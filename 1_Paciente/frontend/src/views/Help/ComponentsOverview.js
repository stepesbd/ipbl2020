  ...
  <div>
    <Container fluid className="px-0">
      <Alert className="mb-0">
        <i className="fa fa-info mx-2"></i> Como vai você? Sou apenas uma mensagem de notificação amigável e bonita e tenho todas as cores que você pode ver abaixo. Muito legal, né?
      </Alert>
    </Container>
